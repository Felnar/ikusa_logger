...
mkdir -p dist/bdo-combat-logger/logger
cp -r logger/dist/logger/* dist/bdo-combat-logger/logger/ || error_exit "Failed to copy logger files."
...
sudo setcap cap_net_raw=eip ./dist/bdo-combat-logger/bdo-combat-logger-linux_x64
sudo setcap cap_net_raw=eip ./dist/bdo-combat-logger/logger/logger

log "Build completed. Compiled files are in dist/bdo-combat-logger/"
